!function() {
    ...
    module.exports = new Class({
        ...
        /**
         * sets the event listener that can be called to emit messages
         * replace old listeners, so that only one lister is called at
         * any times
         *
         * @param <Function> event listbner
         */
        , setMessageEventListener: function(listener) {
            this._messageEventListener = listener;
        }
        ...
        , emitMessage: function(message) {
            if (this._messageEventListener) this._messageEventListener(message);
            else throw new Error('No message eventlistener set on the message, cannot emit the message!');
        }
        ...
        , hasNamedRecipient: function() {
            return this._recipient && this._recipient.id;
        }
